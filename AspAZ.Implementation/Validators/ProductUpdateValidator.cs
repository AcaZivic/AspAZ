...
namespace AspAZ.Implementation.Validators
{
    public class ProductUpdateValidator : AbstractValidator<UpdateProductDTO>
    {
        ...
        public ProductUpdateValidator(GameKingdomContext context)
        {
            _context = context;
            ...
            RuleFor(x => x.Name)
                ...
                .Must((dto,name) => !_context.Products.Any(m => m.Name == name && dto.Id !=m.Id))
            ...
            RuleFor(x => x.BarCode)
                ...
                .Must((dto,x)=>!_context.Products.Any(x=>x.BarCode==dto.BarCode && dto.Id != x.Id))
            ...
            RuleFor(x => x.ProductCode)
                ...
                .Must((dto, x) => !_context.Products.Any(x => x.ProductCode == dto.ProductCode && dto.Id != x.Id))
