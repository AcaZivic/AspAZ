...
namespace AspAZ.Implementation.Validators
{
    public class EmployeeValidator : AbstractValidator<CreateEmployeeDto>
    {
        ...
        public EmployeeValidator(GameKingdomContext context)
        {
            _context = context;
            ...
            RuleFor(x => x.Username)
                ...
                .Must(name => !_context.Employees.Any(m => m.Username == name))
            ...
            RuleFor(x => x.Email)
                ...
                .Must(name => !_context.Employees.Any(m => m.Email == name))
            ...
            RuleFor(x => x.Password)
                ...
                .Must(name => !_context.Employees.Any(m => m.Password == name))
