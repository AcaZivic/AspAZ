...
namespace AspAZ.API.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public CustomersController(UseCaseExecutor executor, IApplicationActor actor)
        {
            _executor = executor;
            _actor = actor;
        }
        ...
        public IActionResult Get(
            [FromQuery] CustomerSearchDTO search,
            [FromServices] IGetCustomerQuery query)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] CreateCustomerDTO dto, [FromServices] ICreateCustomerCommand command)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] UpdateCustomerDTO dto, [FromServices] IUpdateCustomerCommand command)
        {
